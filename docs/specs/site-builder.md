...
| browser test declarations (2026-09-20; inventory, not run results) | **318** |

`apps/site` was 11,410 lines before `PageFrame`, `Rail`, `Inspector`, `Overlay` and `Admin` — those
five — moved into this package. That is the move `note.md` uses as its gauge, and the 318 above is the current inventory quoted in `note.md`; it does not claim that all scenarios passed in this run.
