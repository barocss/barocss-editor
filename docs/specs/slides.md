...
`apps/slide` is 2,435 lines of `app.tsx` and 160 of `main.tsx` and nothing else.
...
| `apps/slide/src` | **2,595 lines** — `app.tsx` 2,435, `main.tsx` 160 |
| browser test declarations | 460 |
