...
2026-09-20: [Slides integration documentation audit](specs/slides-documentation-audit.md) records the implemented deck, viewport, persistence, and playback contracts for #321. Product fixes and UI scenario issues remain separate.
