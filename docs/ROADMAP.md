...
2026-09-20 Schema 문서화: [#308](https://github.com/barocss/barocss-editor/issues/308)에서 schema 검사 수준과 공개 FragmentEditor 사용법을 정리한다. 완성 트리와 열린 조각, 읽기 전용 계획과 transaction 적용, stale 거절과 Undo를 구분한다. [검토 근거와 제외 범위](specs/schema-documentation-audit.md)를 기록하며 제품별 DND UI·구조 편집 및 SDK 지원 등급 완료를 뜻하지 않는다.
