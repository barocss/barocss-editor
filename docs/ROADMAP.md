...
2026-09-20: [Word integration documentation audit](specs/word-documentation-audit.md) records the implementation inventory, host layout/save contracts, and bounded DOCX exchange for #318. Product UI scenario issues #300/#303 remain separate.
