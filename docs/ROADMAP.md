...
2026-09-20 Site 문서화: [#327](https://github.com/barocss/barocss-editor/issues/327)에서 페이지·Note 본문 연결, 네이티브 저장, HTML/ZIP 출력과 호스트 배포 책임을 구분했다. 공개 API 예제와 [소스·검증 기록](specs/site-documentation-audit.md)을 추가했다. 런타임 수정이나 배포 완료를 뜻하지 않으며, 본문 입력 #325와 저장 단축키 #299는 별도 구현 범위다.
