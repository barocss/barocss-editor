...
describe('캐럿 리터럴', () => {
  it('제품 코드에서는 자기가 접혔다고 말한다', () => {
    ...
    expect(found, `깃발 없는 캐럿 리터럴:\n${found.join('\n')}`).toEqual([
      ...
      'packages/editor-view-react/src/input-handler.ts:601',
      'packages/editor-view-react/src/input-handler.ts:654',
      'packages/editor-view-react/src/input-handler.ts:845',
